...
5. Browse to the folder where you extracted the zip file in step 3 and choose the GULF.prf file
...
3. Open the extracted files and copy the DataFiles folder and GULF.ese file. Go to your current sector file folder for GULF and replace the DataFiles and .ese file with the ones you just copied. 
